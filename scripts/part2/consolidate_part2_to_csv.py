...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(ROOT_DIR / "logs/part2/part2_consolidation.log", mode="w", encoding="utf-8"),
...
def main():
    ...
    # Escribir CSV
    csv_path = ROOT_DIR / "data/part2/part2_consolidated.csv"
    write_csv(all_rows, csv_path)

    # Escribir reporte
    report_path = ROOT_DIR / "logs/part2/part2_consolidation_report.txt"
    write_report(all_rows, group_mapping, groups_without_data, report_path)

    logger.info("\n✅ All done!")
    logger.info(f"   CSV: {csv_path}")
    logger.info(f"   Report: {report_path}")
    logger.info(f"   Log: logs/part2/part2_consolidation.log")
